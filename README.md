...
Open Cursor (or your preferred IDE) and create a new project:
    ...
    Windows/Mac/Linux: File → Open Folder → Create a new folder called twin
...
Step 6: Test Your API
    ...
    Go to API details (or Stages → $default)
...
Step 2: Add Bedrock and CloudWatch Permissions to User Group
    ...
    Click Permissions tab → Add permissions → Attach policies
...
Let's create a dashboard to monitor everything at a glance:
    ...
    In CloudWatch, click Dashboards → Create dashboard
...
Monitor your AWS costs:
    ...
    Click Cost Explorer → Launch Cost Explorer
    Filter by:
        Service: Bedrock
        Time: Last 7 days
...
After testing each model, check CloudWatch:
    ...
    Go to CloudWatch → Log groups → /aws/lambda/twin-api
...
To see what's actually costing money:
    ...
    Click Cost Explorer → Cost and usage
    Group by: Service
    Filter: Last 7 days
